...
const MuiTextField = ({ error, helperText, onChange, ...props }) => {
...
export const muiTextField = define(MuiTextField, "MuiTextField")
    ...
    .props({
      ...
      multiline: boolean,
      maxRows: number,
      variant: oneOf("outlined", "standard", "filled").withEditorProps({
        creatable: false
      }),
      size: oneOf("small", "medium").withEditorProps({ creatable: false }),
      margin: oneOf("dense", "normal", "none").withEditorProps({
        creatable: false
      }),
      helperText: string,
